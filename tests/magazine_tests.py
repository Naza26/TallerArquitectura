...
class MagazineTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.error_message = f"Title must be within {Article.MINIMUM_TITLE_LENGTH}-{Article.MAXIMUM_TITLE_LENGTH}" \
                             f" characters long"
    ...
    def test_05_title_of_article_cannot_be_too_short(self):
        ...
        self.assertEqual(self.error_message, str(result.exception))
